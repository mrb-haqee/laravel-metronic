                ...
                <div class="menu-sub menu-sub-accordion">
                    ...
                    <div class="menu-item">
                        ...
                        <a class="menu-link {{ request()->routeIs('user-management.users.*') ? 'active' : '' }}"
                            href="{{ route('user-management.users.index') }}" wire:navigate>
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                    ...
                    <div class="menu-item">
                        ...
                        <a class="menu-link {{ request()->routeIs('user-management.roles.*') ? 'active' : '' }}"
                            href="{{ route('user-management.roles.index') }}" wire:navigate>
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
                    ...
                    <div class="menu-item">
                        ...
                        <a class="menu-link {{ request()->routeIs('user-management.permissions.*') ? 'active' : '' }}"
                            href="{{ route('user-management.permissions.index') }}" wire:navigate>
                            <span class="menu-bullet">
                                <span class="bullet bullet-dot"></span>
                            </span>
...
=======
            ...
            @foreach ($menus as $group => $menu)
                <div data-kt-menu-trigger="click"
                    class="menu-item menu-accordion {{ request()->routeIs($group . '.*') ? 'here show' : '' }}">
                    <!--begin:Menu link-->
                    <span class="menu-link">
                        <span class="menu-icon">{!! getIcon('element-11', 'fs-2') !!}</span>
                        <span class="menu-title"> {{ ucfirst($group) }} </span>
                        <span class="menu-arrow"></span>
                    </span>
                    <!--end:Menu link-->
                    <!--begin:Menu sub-->
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        @foreach ($menu as $row)
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a wire:navigate
                                    class="menu-link {{ request()->routeIs($group . '.' . implode('.', json_decode($row['path'])) . '.*') ? 'active' : '' }}"
                                    href="{{ route($group . '.' . implode('.', json_decode($row['path'])) . '.index') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">{{ $row['namaMenuSub'] }}</span>
                                </a>
                                <!--end:Menu link-->
                            </div>
                        @endforeach
